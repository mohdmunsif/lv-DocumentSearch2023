        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200 flex justify-between">
                <form method="GET" action="{{ route('documents.search') }}">
                    ...
                    <x-input class="ml-3 border-b py-2 px-3 text-grey-darkest shadow-none" name="term"
                        wire:model="term">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('documents.download', $document->id) }}"
                                                ...
                                                Download <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            @can('delete-document', $document)
                                                <form method="POST" action="{{ route('documents.destroy', $document) }}"
                                                    ...
                                                    <x-button class="ml-3 bg-red-500"
                                                        wire:click.prevent="confirmDelete({{ $document->id }})">
